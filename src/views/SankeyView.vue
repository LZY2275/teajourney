<template>
    <div class="sankey" style="width: 100%;height: 100%;display: flex;">
        <div id="sankey-chart-note" style="width: 300px;height: 100%;"></div>
        <div id="sankey-chart" style="width: calc(100% - 300px);height: 100%;"></div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
        createSankey(){
            ...
            var padding = { top: 80, right: 20, bottom: 15, left: 20 };
            ...
            d3.select('#label_text_50')
                .attr('fill','#00000000')

            d3.select('#rect_50')
                .attr('fill','#00000000')

            d3.select('#link_from_43_to_50')
                .attr('stroke','#00000000')

            d3.select('#link_from_44_to_50')
                .attr('stroke','#00000000')
