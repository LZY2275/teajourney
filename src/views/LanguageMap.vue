...
var pronunciationText = [
    {
        ...
        describePronunciation: '俄罗斯的茶文化起源于中国。茶在俄罗斯被称为“чай”（chai），这个词源自中文“茶”（chá）。',//描述读音
    },
    {
        name: '美国',
        teaStyle: '"Tea"',//不同国家茶的文字（默认俄罗斯）
        showPronunciation: '读音为：Ti',//展示读音
