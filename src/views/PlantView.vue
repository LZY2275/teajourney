<template>
    ...
    <div>
        <t-drawer :visible.sync="visible" :placement="placement" :mode="mode" :header="tea_info[current].teatitle"
            :showOverlay="false" showInAttachedElement :cancelBtn="$t('关闭')" :confirmBtn="null">
            <div style="width: 100%;display: flex;margin-bottom: 8px;">
            ...
            tea_info[current].teaprizerange[1] }}</p>
                        <p class="range-note">{{ $t('元/斤') }}</p>
                    </div>
                    <p style="font-size: 10px;">{{$t(平均价格)}}</p>
                </div>
                <div class="tea-info-card" style="margin-left: 2%;">
            ...
            tea_info[current].teafermentdegrange[1] }}</p>
                    ...
                    <p style="font-size: 10px;">{{$t("发酵度")}}</p>
                </div>
            </div>
        ...
        <div style="top: 20px; right: 20px; z-index:99;position:absolute ">
            <t-popup :content="$t('第一次使用？')" placement="left">
    ...
    computed:{
        steps(){
            return [
                {
                    element: '.arc',
                    title: this.$t('茶的类别及品种'),
                    body: this.$t('外圈环显示茶的类别及该类别下茶的品种。颜色代表茶的类别：绿茶、白茶、黄茶、乌龙茶、红茶、黑茶。'),
                    placement: 'bottom-right',
                },
                {
                    element: '.province-hover-arc',
                    title: this.$t('茶省'),
                    body: this.$t('内圈表示产茶省份，点击省份显示省份与茶之间的对应关系与产茶地图。圆环的角度越大，说明该省份产茶越多'),
                    placement: 'bottom',
                },
                {
                    element: '#name-pie-3',
                    title: this.$t('茶的详细信息'),
                    body: this.$t('鼠标点击外环的茶对应的小卡片可以查看该茶的详细信息。'),
                    placement: 'right',
                },
                {
                    element: '.province-hover-arc-g',
                    title: this.$t('产茶地图'),
                    body: this.$t('点击外环的小卡片后展示，显示该省份产地点位等情况。'),
                    placement: 'right',
                },
                {
                    element: '.nav',
                    title: this.$t('导航栏'),
                    body: this.$t('使用导航栏可以进行页面之间的快速跳转。'),
                    placement: 'right',
                },
                {
                    element: '.t-steps-item__inner ',
                    title: this.$t('导航项'),
                    body: this.$t('点击导航项可以直接实现页面的跳转。'),
                    placement: 'right',
                },
            ];
        },
        ...
        tea_info(){
            return [
                ...
                {
                    teatitle: this.$t('碧螺春'),
                    teacontent: this.$t('<p>碧螺春是中国传统名茶，中国十大名茶之一，属于绿茶类，已有1000多年历史。碧螺春产于江苏省苏州市吴县太湖的东洞庭山及西洞庭山（今苏州吴中区）一带，所以又称“洞庭碧螺春”。</p><p>唐朝时就被列为贡品，古人们又称碧螺春为“功夫茶”、“新血茶”。高级的碧螺春，茶芽之细嫩0.5公斤干茶需要茶芽6-7万个。炒成后的干茶条索紧结，白毫显露，色泽银绿，翠碧诱人，卷曲成螺，产于春季，故名“碧螺春”。此茶冲泡后杯中白云翻滚，清香袭人，是中国的名茶。主要工序为杀青、揉捻、搓团显毫、炒青。</p>'),
                    teaimg: require("../assets/img/tea_img_1.png"),
                    teaprizerange: [400, 4000],
                    teafermentdegrange: [0, 0],
                },
                {
                    teatitle: this.$t('黄山毛峰'),
                    teacontent: this.$t('<p>黄山毛峰是中国十大名茶之一，属于绿茶。产于安徽省黄山（徽州）一带，所以又称徽茶。由清代光绪年间谢裕大茶庄所创制。每年清明谷雨，选摘良种茶树“黄山种”、“黄山大叶种”等的初展肥壮嫩芽，手工炒制，该茶外形微卷，状似雀舌，绿中泛黄，银毫显露，且带有金黄色鱼叶（俗称黄金片）。入杯冲泡雾气结顶，汤色清碧微黄，叶底黄绿有活力，滋味醇甘，香气如兰，韵味深长。由于新制茶叶白毫披身，芽尖峰芒，且鲜叶采自黄山高峰，遂将该茶取名为黄山毛峰。</p>'),
                ...
                {
                    teatitle: this.$t('玉露'),
                    teacontent: this.$t('<p>恩施玉露，湖北省恩施市特产，中国国家地理标志产品。 恩施玉露外形条索紧圆光滑、纤细挺直如针，色泽苍翠绿润。经沸水冲泡，芽叶复展如生，初时婷婷地悬浮杯中，继而沉降杯底，平伏完整，汤色嫩绿明亮，如玉露，香气清爽，滋味醇和。观其外形，赏心悦目；饮其茶汤，沁人心脾。</p><p>恩施玉露茶是中国传统蒸青绿茶，选用叶色浓绿的一芽一叶或一芽二叶鲜叶经蒸汽杀青制作而成。恩施玉露对采制的要求很严格，芽叶须细嫩、匀齐，成茶条索紧细匀整，紧圆光滑，色泽鲜绿，匀齐挺直，状如松针，白毫显露，色泽苍翠润绿；茶汤清澈明亮，香气清高持久，滋味鲜爽甘醇，叶底嫩匀明亮，色绿如玉。“三绿”：茶绿、汤绿、叶底绿，为其显著特点。日本自唐代从中国传入茶种及制茶方法后，至今仍主要采用蒸青方法制作绿茶，其玉露茶制法与恩施玉露大同小异，品质各有特色。</p><p>唐朝时就被列为贡品，古人们又称碧螺春为“功夫茶”、“新血茶”。高级的碧螺春，茶芽之细嫩0.5公斤干茶需要茶芽6-7万个。炒成后的干茶条索紧结，白毫显露，色泽银绿，翠碧诱人，卷曲成螺，产于春季，故名“碧螺春”。此茶冲泡后杯中白云翻滚，清香袭人，是中国的名茶。主要工序为杀青、揉捻、搓团显毫、炒青。</p>'),
                ...
                {
                    teatitle: this.$t('滇青'),
                    teacontent: this.$t('<p>滇青，即未经压制的普洱茶散茶原料，云南有悠久历史的茶叶，是采用大叶种茶树的鲜叶，经过杀青、揉捻后，用太阳晒干而成的优质晒青茶。它与历史上经过后熟阶段（即后发酵）越陈越香的普洱茶品质风格各不相同。</p><p>历史上的滇青是按季节命名，有春尖、春中、春尾、二水和谷花等品质级别。现代的滇青就是选用晒青毛茶未经过后熟阶段直接筛制而成，分为：春蕊、春芽、春尖、甲配、乙配、丙配和春玉等花色等级，是云南绿茶中别具一格的优秀产品。滇青茶有经久耐泡的特点，除可作一般茶叶冲泡饮用外，还宜作烤茶冲泡饮用。</p>'),
                ...
                {
                    teatitle: this.$t('寿眉'),
                    teacontent: this.$t('<p>寿眉，乃以福鼎大白、福鼎白茶树制成的白茶。寿眉叶张稍肥嫩，芽叶连枝，无老梗，叶整卷如眉，香气清纯。其中用茶芽叶制成的毛茶称为“小白”，以区别于福鼎大白茶、政和大白茶茶树芽叶制成的“大白”毛茶。菜茶茶芽曾用以制造白毫银针，其后改用大白制白毫银针和白牡丹，而小白则用以制造贡眉。</p><p>优质寿眉毫心显而多，色泽翠绿，汤色橙黄或深黄，叶底匀整、柔软、鲜亮，叶张主脉迎光透视呈红色，味醇爽，香鲜纯。其采摘标准为一芽二叶至一芽二、三叶，要求含有白毫。优质寿眉色泽翠绿，汤色橙黄。</p>'),
                ...
                {
                    teatitle: this.$t('贡眉'),
                    teacontent: this.$t('<p>贡眉又称为寿眉，属于中国六大茶类之一的白茶品项，主产于中国福建省的南平市的松溪县、政和县、建阳市、建瓯市、浦城县等地，是白茶中产量最高的一个品项，其产量约占到了白茶总产量的50%以上。</p><p>优质的贡眉成品茶毫心明显，茸毫色白且多，干茶色泽翠绿，冲泡后汤色呈橙色或深黄色，叶底匀整、柔软、鲜亮，叶片迎光看去，可透视出主脉的红色，品饮时感觉滋味醇爽，香气鲜纯。</p>'),
                    teaimg: require("../assets/img/tea_img_8.png"),
                    teaprizerange: [600, 1500],
                    teafermentdegrange: [10, 20],
                },
                {
                    teatitle: this.$t('黄山白茶'),
                    teacontent: this.$t('<p>黄山白茶，安徽省歙县特产，国家地理标志产品。黄山白茶富含氨基酸、铁、锌、硒等营养元素，特别是氨基酸含量较高,高达9.2%，远超浙江安吉白茶，由于其酚氨比较低，故茶汤滋味极其鲜醇。</p><p>黄山白茶芽白如玉、叶薄如纸。叶脉呈乳白色，冲泡后似凤羽有兰花香，汤色清澈，鲜爽甜香。理化指标：水浸出物≥35%，游离氨基酸总量（以谷氨酸计）≥7.0%。</p>'),
                ...
                // 黄茶
                {
                    teatitle: this.$t('海马宫茶'),
                    teacontent: this.$t('<p>海马宫茶属黄茶类名茶。具有条索紧结卷曲，茸毛显露，青高味醇，回味甘甜，汤色黄绿明亮，叶底嫩黄匀整明亮的特点。</p><p>海马宫茶，由贵州茶农创制于乾隆年间。产于贵州省大方县的老鹰岩脚下的海马宫村。海马宫茶采于当地中，小群体品种，具有茸毛多，持嫩性强的特性。谷雨前后开采。采摘标准；一级茶为一芽一叶初展；二级茶为一芽二叶，三级茶为一芽三叶。海马宫茶属黄茶类名茶。具有条索紧结卷曲，茸毛显露，青高味醇，回味甘甜，汤色黄绿明亮，叶底嫩黄匀整明亮的特点。</p>'),
                    teaimg: require("../assets/img/tea_img_10.png"),
                    teaprizerange: [250, 580],
                    teafermentdegrange: [10, 20],
                },
                {
                    teatitle: this.$t('蒙顶黄芽'),
                    teacontent: this.$t('<p>蒙顶黄芽，是芽形黄茶之一，产于四川省雅安市蒙顶山。蒙顶茶栽培始于西汉，距今已有二千年的历史，古时为贡品供历代皇帝享用，新中国成立后曾被评为全国十大名茶之一。蒙顶黄芽外形扁直，芽条匀整，色泽嫩黄，芽毫显露，花香幽长，汤色黄亮透碧，滋味鲜醇回甘，叶底全芽嫩黄采摘于春分时节，茶树上有10%的芽头鳞片展开，即可开园采摘。选圆肥单芽和一芽一叶初展的芽头，经复杂制作工艺，使成茶芽条匀整，扁平挺直，色泽黄润，金毫显露；汤色黄中透碧，甜香鲜嫩，甘醇鲜爽。为黄茶之极品。</p>'),
                    teaimg: require("../assets/img/tea_img_11.png"),
                    teaprizerange: [150, 580],
                    teafermentdegrange: [10, 20],
                },
                {
                    teatitle: this.$t('霍山黄芽'),
                    teacontent: this.$t('<p>霍山黄芽，安徽省霍山县特产，国家地理标志产品。</p><p>霍山黄芽依其品质分为特一级、特二级、一级和二级。外形挺直微展，色泽黄绿披毫，香气清香持久，汤色黄绿明亮，滋味浓厚鲜醇回甘，叶底微黄明亮。</p><p>2006年12月，霍山黄芽成功获批国家地理标志保护产品称号。</p>'),
                    teaimg: require("../assets/img/tea_img_12.png"),
                    teaprizerange: [200, 500],
                    teafermentdegrange: [10, 20],
                },
                {
                    teatitle: this.$t('广东大叶青'),
                    teacontent: this.$t('<p>大叶青茶为广东的特产。大叶青茶也称广东大叶青，主要产于广东省韶关、肇庆、湛江等县市、属于黄茶，是黄大茶的代表品种之一。制法是先萎凋后杀青，再揉捻闷堆。这与其它黄茶不同。产品品质具有黄茶的一般特点。所以也归属共同茶类。其产地为广东省韶关、肇庆、湛江等县市。广东大叶青为属黄茶类，但与其他黄茶制法不同，其先萎凋后杀青，再揉捻闷堆。杀青前的萎凋和揉捻后闷黄的主要目的是消除青气涩味，促进香味醇和纯正。</p>'),
                    teaimg: require("../assets/img/tea_img_13.png"),
                    teaprizerange: [60, 335],
                    teafermentdegrange: [10, 20],
                },
                {
                    teatitle: this.$t('北港毛尖'),
                    teacontent: this.$t('<p>北港毛尖以注册商标“北港”命名，唐代称“邕（yōng）湖茶”，属黄茶类，产于湖南省岳阳市北港。在加工技术中，通过热闷措施的摧化作用，破坏叶绿素，使不溶性碳水化合物部分转化成可溶性，儿茶素类发生非酶性氧化和异构化作用，其转化产物与蛋白质水解的氨基酸结合，产生新的香味物质，达到茶叶黄化，香味鲜醇回甘。</p><p>1987年在湖南全省名优茶评比中被评为全省名茶。</p>'),
                ...
                {
                    teatitle: this.$t('大红袍'),
                    teacontent: this.$t('<p>大红袍，产于福建武夷山，属乌龙茶，品质优异。中国特种名茶。其外形条索紧结，色泽绿褐鲜润，冲泡后汤色橙黄明亮，叶片红绿相间。品质最突出之处是香气馥郁有兰花香，香高而持久，“岩韵”明显。除与一般茶叶具有提神益思，消除疲劳、生津利尿、解热防暑、杀菌消炎、解毒防病、消食去腻、减肥健美等保健功能外，还具有防癌症、降血脂、抗衰老、等特殊功效。大红袍很耐冲泡，冲泡七、八次仍有香味。品饮“大红袍”茶，必须按“工夫茶”小壶小杯细品慢饮的程式，才能真正品尝到岩茶之颠的禅茶韵味。注重活 、甘、清、香。</p>'),
                ...
                {
                    teatitle: this.$t('肉桂'),
                    teacontent: this.$t('<p>《武夷茶经》里表述：“肉桂，原产马枕峰……已有100多年历史，1985年福建省农作物品种审定委员会认定为省级品种”；《武夷岩茶名丛录》里也有表述：“肉桂，原产马枕峰，慧苑坑等处也有此相同之树。” [3]该茶是以肉桂良种茶树鲜叶，用武夷岩茶的制作方法而制成的乌龙茶，为武夷岩茶中的高香品种。</p><p>本世纪四十年代初已是武夷山茶园栽种的十个品种之一，到六十年代以来，由于其品质特殊，逐渐为人们认可，种植面积逐年扩大，现已发展到武夷山的水帘洞、牛栏坑、马头岩、天心岩、慧苑坑、鹰嘴岩、流香涧、竹窠、悟源涧、九龙窠等地，并且正在大力繁育推广，现已成为武夷岩茶中的主要品种。</p>'),
                ...
                {
                    teatitle: this.$t('水仙'),
                    teacontent: this.$t('<p>水仙茶是福建茶农创制的名茶，属于中国茶叶优良品种之一，是福建乌龙茶类中的一种。原产于闽北。一千年前，建阳、建瓯一带就有这种茶树，但人工栽培却是距今三百多年前的清康熙年间（1662-1722）。水仙茶列“中国国家级茶树良种”48个之首，又是全国41个半乔木大叶型茶树良种的第一个，发源于福建省建阳市唯一的茶树良种。汤色橙黄、香如兰花、滋味醇厚回甘。1985年全国农作物品种审定委员会认定为国家品种，编号GS13009—1985。</p>'),
                ...
                {
                    teatitle: this.$t('北斗'),
                    teacontent: this.$t('<p>北斗：原名北斗一号，武夷山名丛之一。原产于北斗峰（北斗峰在三姑石后面，山势陡峭，钟灵毓秀。相传1400多年前道家取名）现已有60多年的栽培历史，主要分布在武夷山武夷山正岩产区。北斗：无性系，灌木型，中叶类，中生种，品质优，色泽绿褐，香气浓郁鲜爽，滋味浓厚回甘，岩韵明显。抗寒性、抗旱性强。扦插繁殖能力强，成活率高。北斗茶为半发酵茶，其特殊的焙火工艺，不但茶叶品质提高，茶香稳定，还可以延长存放时间。北斗茶干香，清纯辛锐，幽雅秀气，香高持久。一泡入口最明显的就是清澈，细品清纯顺口，回甘甜持久，汤滑甘鲜醇润可口，滋味醇厚。</p>'),
                ...
                // 黑茶
                {
                    teatitle: this.$t('安化黑茶'),
                    teacontent: this.$t('<p>安化黑茶是一种中国传统的发酵茶，产于湖南省安化县。它是以优质毛茶为原料，经过揉捻、杀青、发酵、烘干等工艺制作而成。</p><p>安化黑茶是中国黑茶的始祖，在唐代（856年）的史料中记载为“渠江薄片”，曾列为朝廷贡品，明嘉靖三年（1524年）就正式创制出了安化黑茶。至16世纪末期，安化黑茶已位居中国领先地位，万历年间被定为官茶，大量远销西北。</p><p>安化黑茶外观呈黑褐色，茶汤呈红褐色，滋味醇厚、甘甜，香气独特，有“茶中美酒”之称。安化黑茶的制作历史悠久，已有数百年的历史，是中国茶叶文化的重要组成部分。除了作为一种饮品外，安化黑茶还有一定的药用价值，被广泛用于调理身体和治疗疾病。</p>'),
                ...
                {
                    teatitle: this.$t('普洱茶'),
                    teacontent: this.$t('<p>普洱茶是一种以云南大叶种茶为原料，经过特殊的发酵和储藏工艺制成的茶叶。其历史可以追溯到公元前3000年左右，是中国茶叶中的一种古老品种。</p><p>普洱茶的特点是色泽红褐，香气独特，味道醇厚，有助于消化和降低胆固醇。普洱茶还有很多功效，如促进血液循环、降低血压、减肥等。普洱茶的品质和价值主要取决于原料的品质、制作工艺和储藏时间。</p>'),
                ...
                {
                    teatitle: this.$t('六堡茶'),
                    teacontent: this.$t('<p>六堡茶是中国传统名茶之一，产于广西壮族自治区梧州市的六堡镇，因此得名。六堡茶的历史可以追溯到明朝，已有几百年的栽培和制作历史。</p><p>六堡茶以其独特的香气和口感而闻名。它是一种发酵度较高的黑茶，经过采摘、萎凋、揉捻、发酵、炒制等工序制成。六堡茶的茶叶形状扁平，色泽乌润，茶汤呈红褐色。</p><p>六堡茶的香气浓郁，带有独特的陈香味，入口后回甘顺滑。它具有温暖身体、消食化滞、降脂减肥等功效。六堡茶还含有丰富的茶多酚和咖啡碱，有助于提神醒脑，增强免疫力。六堡茶有多个品种，其中最有名的是六堡大茶、小茶和细茶。六堡大茶叶片较大，茶汤颜色深沉，口感醇厚；小茶叶片较小，茶汤颜色较浅，口感清爽；细茶叶片细小，茶汤颜色红艳，口感浓郁。</p><p>在中国茶文化中，六堡茶被视为一种高品质的茶叶，常作为馈赠礼品或在重要场合上供茶。它的独特风味和历史传承使其成为茶叶爱好者和收藏家们追捧的对象。</p>'),
                    teaimg: require("../assets/img/tea_img_26.png"),
                    teaprizerange: [120, 700],
                    teafermentdegrange: [100, 100],
                },
                {
                    teatitle: this.$t('泾阳茯砖茶'),
                    teacontent: this.$t('<p>泾阳茯砖茶是中国陕西省泾阳县出产的一种特色茶。它是一种压制茶，将新鲜的茶叶经过摊晾、杀青、揉捻、压制等工艺制成砖状。泾阳茯砖茶的茶叶形状规整，色泽深绿。</p><p>泾阳茯砖茶以其独特的香气和口感而闻名。它具有清香高爽、甘醇顺滑的特点。茯砖茶的茶汤呈黄绿色，清澈透亮。它的口感清爽宜人，带有一丝丝的甘甜。</p><p>泾阳茯砖茶具有多种保健功效。它含有丰富的茶多酚、咖啡碱和维生素等营养物质，有助于提神醒脑、消食化滞、降脂减肥等。同时，茯砖茶还具有抗氧化、抗衰老的作用，有助于保护心血管健康。</p>'),
                ...
                {
                    teatitle: this.$t('千两茶'),
                    teacontent: this.$t('<p>千两茶系黑茶茶类中的一个品种， 创制于湖南省安化县江南一带，是安化的一个传统名茶，是以每卷(支)的茶叶净含量合老秤一千两而得名，因其外表的篾篓包装成花格状，故又名花卷茶。</p><p>千两茶的外观呈现出砖形，通常重量在1000克左右，因此得名“千两茶”。它的外观色泽深绿，茶叶质地紧实，香气浓郁。千两茶的口感醇厚，滋味浓烈，具有独特的陈香和甘甜的味道。此外，千两茶还富含丰富的茶多酚和咖啡碱等营养物质，具有一定的保健功效，如提神醒脑、消除疲劳等。</p><p>千两茶在中国茶文化中占有重要地位，被广泛饮用和收藏。它不仅作为一种传统的饮品，还被用作礼品赠送或商务交流的重要礼物。</p>'),
        ...
        name_data(){
            return [[this.$t('西湖龙井'), 1], [this.$t('碧螺春'), 1], [this.$t('黄山毛峰'), 1], [this.$t('玉露'), 1], [this.$t('滇青'), 1],
            [this.$t('白毫银针'), 1], [this.$t('白牡丹'), 1], [this.$t('寿眉'), 1], [this.$t('贡眉'), 1], [this.$t('黄山白茶'), 1],
            [this.$t('海马宫茶'), 1], [this.$t('蒙顶黄芽'), 1], [this.$t('霍山黄芽'), 1], [this.$t('广东大叶青'), 1], [this.$t('北港毛尖'), 1],
            [this.$t('铁观音'), 1], [this.$t('大红袍'), 1], [this.$t('肉桂'), 1], [this.$t('水仙'), 1], [this.$t('北斗'), 1],
            [this.$t('祁门红茶'), 1], [this.$t('滇红'), 1], [this.$t('正山小种'), 1], [this.$t('金骏眉'), 1],
            [this.$t('安化黑茶'), 1], [this.$t('普洱茶'), 1], [this.$t('六堡茶'), 1], [this.$t('泾阳茯砖茶'), 1], [this.$t('千两茶'), 1]];
        },

        province_name(){
            return [[this.$t('皖'), 4], [this.$t('湘'), 3], [this.$t('浙'), 1], [this.$t('黔'), 1],
            [this.$t('滇'), 3], [this.$t('桂'), 1], [this.$t('苏'), 1], [this.$t('川'), 1],
            [this.$t('闽'), 11], [this.$t('陕'), 1], [this.$t('鄂'), 1], [this.$t('粤'), 1]];
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        createProvinceChart(index) {
            ...
            let province_geo_data = [
                {
                    ...
                    value: [
                        {
                            ...
                            location_name: this.$t('黄山白茶-安徽省歙县'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },
                        {
                            marker: [118.14161, 30.27296],
                            location_name: this.$t('黄山毛峰-安徽省黄山'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                        {
                            marker: [117.718228, 29.856608],
                            location_name: this.$t('祁门红茶-安徽省祁门县'),
                            color: '#C54522',
                            type: this.$t('红茶')
                        },
                        {
                            marker: [115.87, 31.05],
                            location_name: this.$t('霍山黄芽-安徽省霍山县'),
                            color: '#E9CB6A',
                            type: this.$t('黄茶')
                        },
                    ...
                    legend: [{ name: this.$t('白茶'), color: '#D9D9D9' }, { name: this.$t('绿茶'), color: '#D0DC89' }, { name: this.$t('黄茶'), color: '#E9CB6A' }, { name: this.$t('红茶'), color: '#C54522' }]
                },
                {
                    name: 'HN',
                    province: this.$t('湖南省'),
                    value: [
                        {
                            ...
                            location_name: this.$t('安化黑茶、千两茶-湖南省益阳市安化县'),
                            color: '#594445',
                            type: this.$t('黑茶')
                        },
                        {
                            marker: [113.152243, 29.356149],
                            location_name: this.$t('北港毛尖-湖南省岳阳市北港'),
                            color: '#E9CB6A',
                            type: this.$t('黄茶')
                        },
                    ...
                    legend: [{ name: this.$t('黄茶'), color: '#E9CB6A' }, { name: this.$t('黑茶'), color: '#594445' }]
                },
                {
                    name: 'ZJ',
                    province: this.$t('浙江省'),
                    value: [
                        {
                            ...
                            location_name: this.$t('西湖龙井-浙江省杭州市西湖龙井村'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                    ...
                    legend: [{ name: this.$t('绿茶'), color: '#D0DC89' }]
                },
                {
                    name: 'GZ',
                    province: this.$t('贵州省'),
                    value: [
                        {
                            ...
                            location_name: this.$t('海马宫茶-贵州省大方县海马宫村'),
                            color: '#E9CB6A',
                            type: this.$t('黄茶')
                        },
                    ...
                    legend: [{ name: this.$t('黄茶'), color: '#E9CB6A' }]
                },
                {
                    name: 'YN',
                    province: this.$t('云南省'),
                    value: [
                        {
                            ...
                            location_name: this.$t('滇青-云南省思茅市'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                        {
                            marker: [100.79739, 22.00749],
                            location_name: this.$t('滇青-云南省西双版纳'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                        {
                            marker: [100.08233, 23.89516],
                            location_name: this.$t('滇青-云南省临沧市'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                        {
                            marker: [99.16579, 25.12107],
                            location_name: this.$t('滇青-云南省保山市'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                        {
                            marker: [98.58486, 24.43232],
                            location_name: this.$t('滇青-云南省德宏傣族景颇族自治州'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                        {
                            marker: [100.26764, 25.60648],
                            location_name: this.$t('滇青-云南省大理市'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },

                        {
                            ...
                            location_name: this.$t('滇红-云南省临沧市'),
                            color: '#C54522',
                            type: this.$t('红茶')
                        },
                        {
                            marker: [99.161761, 25.112046],
                            location_name: this.$t('滇红-云南省保山市'),
                            color: '#C54522',
                            type: this.$t('红茶')
                        },
                        {
                            marker: [99.928460, 24.580424],
                            location_name: this.$t('滇红-云南省凤庆县'),
                            color: '#C54522',
                            type: this.$t('红茶')
                        },

                        {
                            ...
                            location_name: this.$t('普洱茶-云南省西双版纳'),
                            color: '#594445',
                            type: this.$t('黑茶')
                        },
                        {
                            marker: [100.09544042015, 23.890468556279],
                            location_name: this.$t('普洱茶-云南省临沧市'),
                            color: '#594445',
                            type: this.$t('黑茶')
                        },
                        {
                            marker: [100.97256981473, 22.83097918601],
                            location_name: this.$t('普洱茶-云南省普洱市'),
                            color: '#594445',
                            type: this.$t('黑茶')
                        },
                    ...
                    legend: [{ name: this.$t('绿茶'), color: '#D0DC89' }, { name: this.$t('红茶'), color: '#C54522' }, { name: this.$t('黑茶'), color: '#594445' }]
                },
                {
                    name: 'GX',
                    province: this.$t('广西壮族自治区'),
                    value: [
                        {
                            marker: [111.380906, 23.812374],
                            location_name: this.$t('六堡茶-广西壮族自治区梧州市六堡镇'),
                            color: '#594445',
                            type: this.$t('黑茶')
                        },
                    ...
                    legend: [{ name: this.$t('黑茶'), color: '#594445' }]
                },
                {
                    name: 'JS',
                    province: this.$t('江苏省'),
                    value: [
                        {
                            ...
                            location_name: this.$t('碧螺春-江苏省苏州市'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                    ...
                    value: [
                        {
                            ...
                            location_name: this.$t('蒙顶黄牙-四川省雅安市蒙顶山'),
                            color: '#E9CB6A',
                            type: this.$t('黄茶')
                        },
                ...
                },
                {
                    ...
                    value: [
                        {
                            ...
                            location_name: this.$t('白毫银针、白牡丹、寿眉-福建省福鼎市'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },
                        {
                            marker: [118.7854, 27.52629],
                            location_name: this.$t('白毫银针、寿眉、贡眉-福建省松溪县'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },
                        {
                            marker: [119.9008, 27.23513],
                            location_name: this.$t('白毫银针、寿眉-福建省柘荣县'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },
                        {
                            marker: [118.120427, 27.331749],
                            location_name: this.$t('白毫银针、寿眉、贡眉-福建省建阳市'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },
                        {
                            marker: [118.85754, 27.36609],
                            location_name: this.$t('白毫银针、白牡丹、寿眉、贡眉-福建省政和县'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },

                        {
                            ...
                            location_name: this.$t('贡眉-福建省建瓯市'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },
                        {
                            marker: [118.54138, 27.91721],
                            location_name: this.$t('贡眉-福建省浦城县'),
                            color: '#D9D9D9',
                            type: this.$t('白茶')
                        },

                        {
                            ...
                            location_name: this.$t('正山小种-福建省武夷山'),
                            color: '#C54522',
                            type: this.$t('红茶')
                        },
                        {
                            marker: [117.680638, 27.747242],
                            location_name: this.$t('金骏眉-福建省武夷山'),
                            color: '#C54522',
                            type: this.$t('红茶')
                        },

                        {
                            ...
                            location_name: this.$t('铁观音-福建省泉州市安溪县'),
                            color: '#EC8924',
                            type: this.$t('乌龙茶')
                        },
                        {
                            marker: [117.68063, 27.7472],
                            location_name: this.$t('大红袍、肉桂、北斗-福建省武夷山'),
                            color: '#EC8924',
                            type: this.$t('乌龙茶')
                        },
                        {
                            marker: [117.419823, 25.290475],
                            location_name: this.$t('水仙-福建省漳平市'),
                            color: '#EC8924',
                            type: this.$t('乌龙茶')
                        },
                    ...
                    legend: [{ name: this.$t('白茶'), color: '#D9D9D9' }, { name: this.$t('红茶'), color: '#C54522' }, { name: this.$t('乌龙茶'), color: '#EC8924' },]
                },
                {
                    name: 'SX',
                    province: this.$t('陕西省'),
                    value: [
                        {
                            ...
                            location_name: this.$t('泾阳茯砖茶-陕西省泾阳县'),
                            color: '#594445',
                            type: this.$t('黑茶')
                        },
                    ...
                    value: [
                        {
                            ...
                            location_name: this.$t('玉露-湖北省恩施市'),
                            color: '#D0DC89',
                            type: this.$t('绿茶')
                        },
                    ...
                    value: [
                        {
                            ...
                            location_name: this.$t('广东大叶青-广东省韶关市'),
                            color: '#E9CB6A',
                            type: this.$t('黄茶')
                        },
            ...
            $.get(province_geo_data[index].path, function (usaJson) {
                ...
                option = {
                    title: {
                        text: _this.$t(province_geo_data[index].province),
                    ...
                    tooltip: {
                        ...
                        formatter: function (params) {
                            ...
                            return _this.$t(params.data.name)
                        }
                    },
                    legend: {
                    ...
                    series: [
                        {
                            ...
                            data: province_geo_data[index].value.map(function (item) {
                                if (item.type == _this.$t('绿茶')) {
                                    return {
                                        name: _this.$t(item.location_name),
                                        value: item.marker,
