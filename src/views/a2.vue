...
export default {
  ...
  methods: {
    ...
    drawLineChart() {
      ...
      // 安徽省的圆
      const data1 = [
        { province: this.$t('安徽'), year: 2018, radius: 14.865, value: 118.02 },
        { province: this.$t('安徽'), year: 2019, radius: 16.321, value: 145.50 },
        { province: this.$t('安徽'), year: 2020, radius: 16.356, value: 146.17 },
        { province: this.$t('安徽'), year: 2021, radius: 17.923, value: 175.73 },
        { province: this.$t('安徽'), year: 2022, radius: 18.287, value: 182.60 },
      ];
      // 湖南省的圆
      const data2 = [
        { province: this.$t('湖南'), year: 2018, radius: 18.476, value: 186.17 },
        { province: this.$t('湖南'), year: 2019, radius: 16.392, value: 146.85 },
        { province: this.$t('湖南'), year: 2020, radius: 16.997, value: 158.27 },
        { province: this.$t('湖南'), year: 2021, radius: 17.702, value: 171.57 },
        { province: this.$t('湖南'), year: 2022, radius: 17.990, value: 177.01 },
      ];
      // 浙江省的圆
      const data3 = [
        { province: this.$t('浙江'), year: 2018, radius: 19.540, value: 206.25 },
        { province: this.$t('浙江'), year: 2019, radius: 20.520, value: 224.74 },
        { province: this.$t('浙江'), year: 2020, radius: 21.254, value: 238.60 },
        { province: this.$t('浙江'), year: 2021, radius: 22.343, value: 259.14 },
        { province: this.$t('浙江'), year: 2022, radius: 22.600, value: 264.00 },
      ];
      // 贵州省的圆
      const data4 = [
        { province: this.$t('贵州'), year: 2018, radius: 23.501, value: 281.00 },
        { province: this.$t('贵州'), year: 2019, radius: 25.666, value: 321.86 },
        { province: this.$t('贵州'), year: 2020, radius: 30.116, value: 405.84 },
        { province: this.$t('贵州'), year: 2021, radius: 30.581, value: 414.60 },
        { province: this.$t('贵州'), year: 2022, radius: 34, value: 498.00 },
      ];
      // 云南省的圆
      const data5 = [
        { province: this.$t('云南'), year: 2018, radius: 17.333, value: 164.61 },
        { province: this.$t('云南'), year: 2019, radius: 19.112, value: 198.17 },
        { province: this.$t('云南'), year: 2020, radius: 19.466, value: 204.85 },
        { province: this.$t('云南'), year: 2021, radius: 19.321, value: 202.12 },
        { province: this.$t('云南'), year: 2022, radius: 20.916, value: 232.21 },
      ];

      // 广西省的圆
      const data6 = [
        { province: this.$t('广西'), year: 2018, radius: 11.629, value: 56.97 },
        { province: this.$t('广西'), year: 2019, radius: 12.231, value: 68.33 },
        { province: this.$t('广西'), year: 2020, radius: 12.996, value: 82.76 },
        { province: this.$t('广西'), year: 2021, radius: 13.820, value: 98.30 },
        { province: this.$t('广西'), year: 2022, radius: 15.216, value: 124.66 },
      ];
      // 江苏省的圆
      const data7 = [
        { province: this.$t('江苏'), year: 2018, radius: 10, value: 26.22 },
        { province: this.$t('江苏'), year: 2019, radius: 10.076, value: 27.66 },
        { province: this.$t('江苏'), year: 2020, radius: 10.160, value: 29.24 },
        { province: this.$t('江苏'), year: 2021, radius: 10.364, value: 33.09 },
        { province: this.$t('江苏'), year: 2022, radius: 10.346, value: 32.74 },
      ];

      // 四川省的圆
      const data8 = [
        { province: this.$t('四川'), year: 2018, radius: 21.648, value: 246.04 },
        { province: this.$t('四川'), year: 2019, radius: 23.432, value: 279.69 },
        { province: this.$t('四川'), year: 2020, radius: 23.717, value: 285.07 },
        { province: this.$t('四川'), year: 2021, radius: 26.362, value: 335.00 },
        { province: this.$t('四川'), year: 2022, radius: 28.068, value: 367.19 },
      ];
      // 福建省的圆
      const data9 = [
        { province: this.$t('福建'), year: 2018, radius: 22.248, value: 257.36 },
        { province: this.$t('福建'), year: 2019, radius: 24.363, value: 297.27 },
        { province: this.$t('福建'), year: 2020, radius: 24.000, value: 290.42 },
        { province: this.$t('福建'), year: 2021, radius: 24.408, value: 298.12 },
        { province: this.$t('福建'), year: 2022, radius: 25.015, value: 309.58 },
      ];
      // 陕西省的圆
      const data10 = [
        { province: this.$t('陕西'), year: 2018, radius: 16.058, value: 140.55 },
        { province: this.$t('陕西'), year: 2019, radius: 17.246, value: 162.96 },
        { province: this.$t('陕西'), year: 2020, radius: 17.259, value: 163.21 },
        { province: this.$t('陕西'), year: 2021, radius: 19.014, value: 196.32 },
        { province: this.$t('陕西'), year: 2022, radius: 19.879, value: 212.65 },
      ];

      // 湖北省的圆
      const data11 = [
        { province: this.$t('湖北'), year: 2018, radius: 16.345, value: 145.96 },
        { province: this.$t('湖北'), year: 2019, radius: 16.956, value: 157.49 },
        { province: this.$t('湖北'), year: 2020, radius: 18.573, value: 188 },
        { province: this.$t('湖北'), year: 2021, radius: 20.370, value: 221.91 },
        { province: this.$t('湖北'), year: 2022, radius: 20.125, value: 217.29 },
      ];
      // 广东省的圆
      const data12 = [
        { province: this.$t('广东'), year: 2018, radius: 10.960, value: 44.34 },
        { province: this.$t('广东'), year: 2019, radius: 14.175, value: 105.00 },
        { province: this.$t('广东'), year: 2020, radius: 16.760, value: 153.79 },
        { province: this.$t('广东'), year: 2021, radius: 16.920, value: 156.80 },
        { province: this.$t('广东'), year: 2022, radius: 18.103, value: 179.13 },
      ];
