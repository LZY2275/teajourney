<template>
    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;height: 80%;background-color: #FFFEF2;">
    ...
    <div style="flex-grow: 1.5; background-color: #f0f0f0;">第一个区域</div>
    <div style="flex-grow: 3.5; background-color: #e0e0e0; position: relative;">
        <!-- 中国地图容器 -->
        <div id="china-map" style="width: 100%; height: 100%;"></div>
    </div>
    <div style="flex-grow: 1; background-color: #d0d0d0;">第三个区域</div>
</div>

<!-- 右侧选项列表 -->
<div style="flex-grow: 1; background-color: #d0d0d0; padding: 10px;">
    <div style="margin-bottom: 10px;">
        <div style="cursor: pointer;" @click="highlightProvince('北京')">北京</div>
        <div style="cursor: pointer;" @click="highlightProvince('上海')">上海</div>
        <div style="cursor: pointer;" @click="highlightProvince('广东')">广东</div>
        <div style="cursor: pointer;" @click="highlightProvince('浙江')">浙江</div>
        <div style="cursor: pointer;" @click="highlightProvince('江苏')">江苏</div>
        <div style="cursor: pointer;" @click="highlightProvince('四川')">四川</div>
    </div>
</div>
