<template>
  <div id="memory-game">
    ...
    <div class="modal" v-if="showStartGameModal">
    <div class="modal-content">
      <p>Please start the game first!</p>
      <button @click="hideStartGameModal">OK</button>
    </div>
  </div>
    <t-dialog
      theme="success"
...
export default {
  ...
  data() {
    return {
      ...
      showModal: false,
      showStartGameModal: false // 初始化为 false，确保一开始隐藏模态框
    };
  },
  computed: {
    topCards() {
