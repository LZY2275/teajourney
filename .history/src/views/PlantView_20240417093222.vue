<template>
    ...
    <div style="margin-bottom: 10px;">
        <div style="display: flex; align-items: center; cursor: pointer;" @click="highlightProvince('北京')">
            <div>北京</div>
            <img src="beijing.jpg" alt="北京图片" style="width: 20px; height: 20px; margin-left: 10px;">
        </div>
        <div style="display: flex; align-items: center; cursor: pointer;" @click="highlightProvince('上海')">
            <div>上海</div>
            <img src="shanghai.jpg" alt="上海图片" style="width: 20px; height: 20px; margin-left: 10px;">
        </div>
        <!-- 其他选项 -->
    </div>
</div>
