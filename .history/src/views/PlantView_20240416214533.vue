<template>
    ...
    <div>
            ...
            <div style="width: 100%;display: flex;margin-bottom: 8px;">
                <div class="tea-info-card" style="text-align: center;">
                    <div style="display: flex;justify-content: center;">
                        <p class="range-text">{{ tea_info[current].teaprizerange[0] }}-{{ tea_info[current].teaprizerange[1] }}</p><p class="range-note">元/斤</p>
                    </div>
                    <p style="font-size: 10px;">平均价格</p>
                </div>
                <div class="tea-info-card" style="margin-left: 2%;">
                    <div style="display: flex;justify-content: center;">
                        <p class="range-text">{{ tea_info[current].teafermentdegrange[0] }}-{{ tea_info[current].teafermentdegrange[1] }}</p><p class="range-note">%</p>
                    </div>
        ...
        <div id="chart" style="height: 200vh;display: flex;justify-content: center;align-items: center;">
    <div id="province" style="width: 32vh;height: 64vh;z-index: 999;"></div>
</div>
