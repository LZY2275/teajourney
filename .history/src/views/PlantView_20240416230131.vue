<template>
    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;height: 100%;background-color: #FFFEF2;">
    <div style="height: 20%; display: flex; align-items: center;">
        <img src="../assets/img/Origin.png" alt="image" style="height: 90%;width:17%;margin-top: 20px;margin-left: 40px;"> 
        <div>
    ...
    <div style="height: 80%;">
        <div style=""flex-grow: 1;width: 33.33%; background-color: #f0f0f0;">第一个区域</div>
    <div style="width: 33.33%; background-color: #e0e0e0;">第二个区域</div>
    <div style="width: 33.33%; background-color: #d0d0d0;">第三个区域</div>
    </div>
</t-layout>
