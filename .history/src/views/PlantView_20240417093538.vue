                ...
                <div style="flex-grow: 1; background-color: #d0d0d0; padding: 10px;">
                    <div style="margin-bottom: 10px;">
                        ...
                        <div style="display: flex; align-items: center; cursor: pointer;"
                            ...
                            <img src="../assets/img/producetea13.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;"><div>绿茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;"
                            @click="highlightProvince('绿茶')">
                            <div>绿茶</div>
                            <img src="green_tea.jpg" alt="" style="width: 20px; height: 20px; margin-left: 10px;">
                        </div>
                    </div>
                </div>
            </div>
