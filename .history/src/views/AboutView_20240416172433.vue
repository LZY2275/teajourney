<template>
  <div id="memory-game">
    ...
    <t-dialog
      ...
      :cancelBtn="null"
    />
    <t-button theme="success"  @click="startGame" v-if="!gameStarted">Start Game</t-button>
    <t-button theme="success" @click="resetGame" v-if="gameStarted">Start Game</t-button>
