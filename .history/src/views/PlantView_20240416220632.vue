    ...
    <div>
        ...
        <div style="border: 1px solid black;height: 100%;">
            ...
            <div style="display: flex; flex-direction: column;">
                <div style="display: flex; justify-content: flex-start; height: 30%; border: 1px solid black;">1</div>
                <div style="display: flex; justify-content: center; height: 50%; border: 1px solid black;">2</div>
                <div style="display: flex; justify-content: flex-end; height: 20%; border: 1px solid black;">3</div>
            </div>
