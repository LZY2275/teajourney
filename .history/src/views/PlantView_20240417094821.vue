<template>
    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;height: 60%;background-color: #FFFEF2;">
            ...
            <div style="display: flex; height: 100%;">
                ...
                <div style="flex-grow: 1; padding: 10px;">
                        ...
                        <div style="display: flex; align-items: center; cursor: pointer;"
                            ...
                            <img src="../assets/img/producetea13.jpg" alt="" style="width: 40px; height: 40px; margin-left: 5vbhbh;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">绿茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;margin-top: 10px;"
