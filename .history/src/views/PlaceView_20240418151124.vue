<template>
    ...
    <t-layout style="background-color: #FFFEF2;z-index: 1;">
               ...
               <div style="display: flex; height: 100%;">
                   <div>
                       ...
                       <!--左下角折线图-->
                       <div id="line-chart" style="margin-top: -30vh;width:40%;height:35%;"></div>
                   </div>
                   <!--六个图标-->
 ...
 tooltip: {
  ...
  legend: {
    data: ['四川', '贵州', '广西', '湖南', '湖北', '陕西', '河南', '安徽', '江苏', '江西', '福建', '浙江']
  },
  grid: {
    left: '3%',
    right: '4%',
  ...
  series: [
    {
      ...
      lineStyle: {
       ...
       data: [545.1, 575, 586, 596.2, 605.38, 598]
    },
    {
      name: '贵州',
      type: 'line',
...
data: [684.3, 698.7, 716.31, 714.6, 708.34, 700]
    },
    {
      name: '广西',
      type: 'line',
       ...
       data: [115.6, 115.6, 118.23, 142.44, 151.73, 155.2]
    },
    {
      name: '湖南',
      type: 'line',
      ...
      data: [253.3, 266.3, 274, 298.1, 310.82, 330]
    },
    {
      name: '湖北',
      type: 'line',
      ...
      data: [449, 495, 513.71, 545.01, 558.03, 564]
    },
      {
      name: '陕西',
      type: 'line',
     ...
     data: [207, 215.4, 233, 233.66, 235.73, 250.59]
    },
      {
      name: '河南',
      type: 'line',
      ...
      data: [174.5, 174.5, 205.2, 208.6, 175.11, 215]
    },
      {
      name: '安徽',
      type: 'line',
       ...
       data: [254.5, 280.3, 286.32, 295.73, 307.52, 320]
    },
      {
      name: '江苏',
      type: 'line',
      ...
      data: [50.6, 50.8, 50.8, 51.45, 51, 49.26]
    },
      {
      name: '江西',
      type: 'line',
      ...
      data: [171.3, 164.9, 169, 171.8, 175.7, 185]
    },
      {
      name: '福建',
      type: 'line',
    ...
    data: [310.8, 327.8, 335.4, 341.22, 352.05, 368]
    },
       {
      name: '浙江',
      type: 'line',
 ...
 data: [298.8, 306, 307.5, 307.7, 310.5, 311.7]
    }
  ]
   ...
   .echarts-tooltip {
            left: auto;
            right: 10px; /* 调整 tooltip 的位置 */
        }
        .echarts-legend {
            left: 100px; /* 调整 legend 的位置 */
            top: 10px;
            text-align: left; /* 设置 legend 左对齐 */
        }
   </style>