<template>
    ...
    <div style="height: 20%; display: flex; align-items: center;border: 1px solid black;">
        <img src="your-image-url.jpg" alt="image" style="margin-right: 10%;"> <!-- 图片 -->
        <div>
    ...
    <div style="height: 80%;">Footer</div>
</t-layout>
