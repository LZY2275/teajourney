<template>
        ...
        <div style="width: 100%;display: flex;margin-bottom: 8px;">
            <div class="tea-info-card" style="text-align: center;">
                <div style="display: flex;justify-content: center;">
                    <p class="range-text">{{ tea_info[current].teaprizerange[0] }}-{{ tea_info[current].teaprizerange[1] }}</p>
            ...
            <div class="tea-info-card" style="margin-left: 2%;">
                <div style="display: flex;justify-content: center;">
                    <p class="range-text">{{ tea_info[current].teafermentdegrange[0] }}-{{ tea_info[current].teafermentdegrange[1] }}</p>
    ...
    <div style="height: 20%; display: flex; align-items: center;">
        <img src="../assets/img/Origin.png" alt="image" style="height: 100%;width:15%;margin-top: 20px;margin-left: 40px;"> 
        <div>
