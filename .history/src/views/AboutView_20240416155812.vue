      ...
      <div class="row">
        ...
        >
          <div class="card-inner">
            ...
            <div class="card-back">
              <img v-if="card.flipped" :src="getImage(card.value)" alt="card image">
            </div>
          </div>
        </div>
      </div>
...
export default {
  data() {
    return {
      ...
      gameStarted: false,
      images: {
        A: "path/to/imageA.jpg",
        B: "path/to/imageB.jpg",
        C: "path/to/imageC.jpg",
        D: "path/to/imageD.jpg",
        E: "path/to/imageE.jpg",
        F: "path/to/imageF.jpg"
      }
    };
  },
  computed: {
