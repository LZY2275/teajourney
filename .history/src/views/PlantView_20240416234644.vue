...
<!--产地-->
<t-layout style="border: 1px solid black; height: 80%; background-color: #FFFEF2; position: relative;">
    <!-- 左侧抽屉 -->
    <div style="position: absolute; top: 0; left: 0; width: 200px; height: 100%; background-color: #fff;">
        <!-- 这里放置抽屉内容 -->
    </div>
