            ...
            <div style="height: 20%; display: flex; ">
                ...
                <div>
                    ...
                    <p class="textsub" v-show="GreenTea">
                        ...
                        除了地理位置优越和自然条件得天独厚外，西湖龙井茶产区还因其悠久的茶史和精湛的制茶工艺而闻名。当地的茶农们世代相传着制茶的技艺，他们手工采摘、炒制的技艺独具匠心，使得西湖龙井茶具有独特的清香和口感，倍受国内外茶客的喜爱。这种传统的制茶工艺也被列为中国非物质文化遗产，体现了中国茶文化的深厚底蕴和博大精深。
                    </p>
                </div>
                <div>
