...
<div style="display: flex;">
                <!--中国地图-->
                <div id="china-map" style="margin-left: 12vw;width: 50vw;height: 70vh;">
               
            </div>
             <!--左下角折线图-->
             <div id="line-chart" style="margin-top: 10vh;;width: 70vw;height: 50vh; "></div>
        </div>
                <!--六个图标-->
                <div style="padding: 10px;margin-right: 18vw;">
        ...
        highlightProvince(teaType) {
            if (teaType === '绿茶') {
                ...
                myChart.setOption({
                    ...
                    legend: {
                        data: ['出口量', '进口量', '出口额', '进口额', '出口均价', '进口均价']
                    },
                    toolbox: {
                        feature: {
                            saveAsImage: {}
