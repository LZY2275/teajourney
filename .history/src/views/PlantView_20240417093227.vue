    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;height: 80%;background-color: #FFFEF2;">
            ...
            <div style="display: flex; height: 100%;">
                ...
                <div style="flex-grow: 3.5; background-color: #e0e0e0;">第二个区域</div>
                <div style="flex-grow: 1; background-color: #d0d0d0; padding: 10px;">
                    <div style="margin-bottom: 10px;">
                        <div style="cursor: pointer;" @click="highlightProvince('绿茶')">绿茶</div>
                        <div style="cursor: pointer;" @click="highlightProvince('白茶')">白茶</div>
                        <div style="cursor: pointer;" @click="highlightProvince('黄茶')">黄茶</div>
                        <div style="cursor: pointer;" @click="highlightProvince('乌龙茶')">乌龙茶</div>
                        <div style="cursor: pointer;" @click="highlightProvince('红茶')">红茶</div>
                        <div style="cursor: pointer;" @click="highlightProvince('黑茶')">黑茶</div>
                    </div>
                </div>
            </div>
