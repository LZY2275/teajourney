<template>
    ...
    <div class="cards">
      <div class="row">
        <div
          ...
          @mouseover="cardHovered = index"
          @mouseleave="cardHovered = null"
        >
        <div class="card-inner">
  <div class="card-front" style="background-image: url('https://img0.baidu.com/it/u=3318691808,1333308276&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=667')"></div>
  <div class="card-back">
    <img :src="getImage(card.value)" alt="card image" class="card-image" v-show="card.flipped">
      ...
      <div class="row">
        <div
          ...
          @mouseover="cardHovered = index + totalPairs"
          @mouseleave="cardHovered = null"
        >
        <div class="card-inner">
  <div class="card-front" style="background-image: url('https://img0.baidu.com/it/u=3318691808,1333308276&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=667')"></div>
  ...
  <t-dialog
      ...
      header="警告!"
      :body="'请先点击开始按钮！'"
      :visible.sync="showStartGameModal"
      @confirm="closeModal1"
      :cancelBtn="null"
    />
    <t-dialog
...
.card.hover {
  ...
  cursor: pointer;
  /* 鼠标悬停时显示手型 */
  transition: transform 0.3s ease; /* 添加过渡效果，持续时间为0.3秒 */
