            ...
            <div style="height: 20%; display: flex; align-items: center;">
                ...
                <div>
                    ...
                    <p class="textsub" v-show="oolong">
                        福建省的武夷山、安溪、南安等地是乌龙茶的著名产区之一。乌龙茶是一种半发酵茶，制作工艺介于绿茶和红茶之间，具有独特的清香和鲜爽口感。乌龙茶的制作工艺包括摇青、杀青、揉捻、发酵、烘焙等多个步骤，其中的发酵过程尤为关键，决定了乌龙茶的风味和品质。乌龙茶口感鲜爽，香气芬芳，被誉为"茶中王者"，深受茶叶爱好者的喜爱。
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="textsub" v-show="BlackTea">
                        云南省的普洱茶是最为著名的黑茶之一，其制作工艺历史悠久，具有独特的陈香和醇厚口感。广西的六堡茶和湖南的安化黑茶也是知名的黑茶品种，它们的口感丰富深邃，带有特有的陈香和木香味。黑茶的制作工艺独特，经过发酵、压制、贮存等多道工序，使得茶叶呈现出深红至黑褐色的色泽，香气独特，口感浓郁醇厚。
                    </p>
                </div>
            </div>
...
<div>
             ...
             <!--左下角折线图-->
             <div id="line-chart" style="margin-top: -30vh;width:40%;height:50%;"></div>
        </div>
                <!--六个图标-->
