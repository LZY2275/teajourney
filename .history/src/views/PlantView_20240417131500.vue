<template>
    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;background-color: #FFFEF2;">
            <div style="height: 20%; display: flex; align-items: center;">
                <img src="../assets/img/Origin.png" alt="image"
                    style="height: 100%;width:15%;margin-top: 20px;margin-left: 40px;">
                <div>
                    <p class="text">主要产区介绍：</p>
                    <p class="textsub">
                        这里是主要产区介绍这里是主要产区介绍这里是主要产区介绍这里是主要产区介绍这里是主要产区介绍这里是主要产区介绍这里是主要产区介绍这里是主要产区介绍。
                    </p>
                </div>
            </div>
            <div style="display: flex; height: 100%;">
                <div style="background-color: #f0f0f0;">第一个区域</div>
                <!--中国地图-->
                <div id="china-map" style="margin-left: 12vw;width: 50vw;height: 70vh;"></div>
                <!--六个图标-->
                <div style="padding: 10px;margin-right: 8vw;">
    
                        <div style="display: flex; align-items: center; cursor: pointer;"
                            @click="highlightProvince('绿茶')">
                            <img src="../assets/img/producetea13.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">绿茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;margin-top: 5vh;"
                            @click="highlightProvince('白茶')">
                            <img src="../assets/img/producetea14.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">白茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;margin-top: 5vh;"
                            @click="highlightProvince('黄茶')">
                            <img src="../assets/img/producetea15.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">黄茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;margin-top: 5vh;"
                            @click="highlightProvince('乌龙茶')">
                            <img src="../assets/img/producetea16.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">乌龙茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;margin-top: 5vh;"
                            @click="highlightProvince('红茶')">
                            <img src="../assets/img/producetea17.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">红茶</div>
                        </div>
                        <div style="display: flex; align-items: center; cursor: pointer;margin-top: 5vh;"
                            @click="highlightProvince('黑茶')">
                            <img src="../assets/img/producetea18.jpg" alt="" style="width: 40px; height: 40px; margin-left: 10px;">
                            <div style="padding-left: 10px;;width: 10px; font-family: 'STXingkai', sans-serif; font-size: 20px; color: #666;">黑茶</div>
                        </div>
                </div>
            </div>
...
export default {
  ...
  this.myChart.setOption(option);
    ...
    option.series[0].data = highlightedProvinces.map(province => {
        return { 
            name: province, 
            itemStyle: { areaColor: '#2E8B57' , borderColor: '#006400',  borderWidth: 1},
            label: {
                show: true, // 显示标签
    ...
    this.myChart.setOption(option);
      ...
      if (teaType === '白茶') {
        ...
        option.series[0].data = highlightedProvinces.map(province => {
            return { 
            name: province, 
            itemStyle: { areaColor: '#F5FFF3', borderColor: '#F5F5DC', borderWidth: 1 },
            label: {
                show: true, // 显示标签
                formatter: '{b}', // 标签内容为省份名称
                color: 'black', // 标签文字颜色
      ...
      if (teaType === '黄茶') {
        ...
        option.series[0].data = highlightedProvinces.map(province => {
            return { 
            name: province, 
            itemStyle: { areaColor: '#f0e68c',borderColor: '#FFFF00', borderWidth: 1 },
            label: {
                show: true, // 显示标签
                formatter: '{b}', // 标签内容为省份名称
                color: 'black', // 标签文字颜色
      ...
      if (teaType === '乌龙茶') {
        ...
        option.series[0].data = highlightedProvinces.map(province => {
            return { 
            name: province, 
            itemStyle: { areaColor: '#DAA520',borderColor: '#B8860B', borderWidth: 1 },
            label: {
                show: true, // 显示标签
                formatter: '{b}', // 标签内容为省份名称
                color: 'black', // 标签文字颜色
      ...
      if (teaType === '黑茶') {
        ...
        option.series[0].data = highlightedProvinces.map(province => {
            return { 
            name: province, 
            itemStyle: { areaColor: '#696969',borderColor: '#B8860B', borderWidth: 1 },
            label: {
                show: true, // 显示标签
                formatter: '{b}', // 标签内容为省份名称
                color: 'black', // 标签文字颜色
