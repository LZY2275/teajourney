    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;background-color: #FFFEF2;">
            ...
            <div style="display: flex; height: 100%;">
                ...
                <div style="flex-grow: 6; background-color: #e0e0e0; position: relative;">
        <!-- 中国地图容器 -->
    ...
    series: [
      {
        ...
        data: [
          // 在这里填写各个省份的数据，示例如下
          {name: '北京', value: Math.random() * 1000000},
          {name: '天津', value: Math.random() * 1000000},
          {name: '上海', value: Math.random() * 1000000},
          // ...
        ]
      }
    ]
