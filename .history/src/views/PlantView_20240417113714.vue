    ...
    <div>
        ...
        <t-layout style="border: 1px solid black;background-color: #FFFEF2;">
            ...
            <div style="display: flex; height: 100%;">
                <div style="flex-grow: 2; background-color: #f0f0f0;">第一个区域</div>
                <!--中国地图-->
                <div id="china-map" style="flex-grow: 6;margin-left: 12vw;width: 50px;height: 50px;"></div>
                <!--六个图标-->
                <div style="flex-grow: 1; padding: 10px;margin-right: 8vw;">
...
export default {
    ...
    highlightProvince(teaType) {
      if (teaType === '绿茶') {
        ...
        const highlightedProvinces = ['四川', '云南', '安徽', '浙江']
        const option = this.myChart.getOption()
        option.series[0].data = highlightedProvinces.map(province => {
          return { name: province, itemStyle: { areaColor: 'rgba(255, 99, 71, 0.5)' } }
        })
        this.myChart.setOption(option)
      }
      if (teaType === '白茶') {
