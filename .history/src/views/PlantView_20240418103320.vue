<template>
    ...
    <div>
        <t-drawer :visible.sync="visible" :placement="placement" :mode="mode" :header="tea_info[current].teatitle"
            :showOverlay="false" showInAttachedElement style="height: 50%;position: absolute; top: 0; left: 0; z-index: 999;">
            <div style="width: 100%;display: flex;margin-bottom: 8px;">
        ...
        <!--产地-->
        <t-layout style="background-color: #FFFEF2;position: relative; z-index: 1;">
